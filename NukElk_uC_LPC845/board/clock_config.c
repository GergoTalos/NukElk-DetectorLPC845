...
- {id: IOCON0_clock.outFreq, value: 15 MHz}
- {id: IOCON1_clock.outFreq, value: 7.5 MHz}
- {id: LowPower_clock.outFreq, value: 10 kHz}
...
- {id: SYSCON.FRG1CLKSEL.sel, value: NO_CLOCK}
- {id: SYSCON.FRO_DIRECT.sel, value: SYSCON.fro_osc}
- {id: SYSCON.IOCONCLKDIV0.scale, value: '2'}
- {id: SYSCON.IOCONCLKDIV1.scale, value: '4'}
- {id: SYSCON.SCTCLKSEL.sel, value: NO_CLOCK}
- {id: SYSCON.SPI0CLKSEL.sel, value: SYSCON.FRO_DIRECT}
...
void BOARD_BootClockFRO30M(void)
{
    ...
    CLOCK_Select(kSPI0_Clk_From_Fro);                      /*!< select FRO for SPI0 */
    CLOCK_SetCoreSysClkDiv(1U);
    CLOCK_SetClkDivider(kCLOCK_IOCONCLKDiv0, 2U);  /*!< set IOCOMCLK0 div */
    CLOCK_SetClkDivider(kCLOCK_IOCONCLKDiv1, 4U);  /*!< set IOCOMCLK1 div */
    /*!< Set SystemCoreClock variable. */
